  ...
  function (
    ...
    return Controller.extend("ui5con.p13nApp.controller.Mountains", {
      ...
      _initGridFilter: function () {
        ...
        Engine.getInstance().register(oGridFilter, {
            ...
            Items: new SelectionController({
              ...
              selector: function (oProperty) {
                return !!this.byId("table")
                  .getBinding("items")
                  .aFilters.find(function (oFilter) {
                    var oMetaData = oFilterHelper.getProperty(oProperty.key);
                    return (
                      oFilter.getPath() === oMetaData.expression[0] &&
                      oFilter.getValue1() === oMetaData.expression[2]
                    );
                  });
              }.bind(this),
            }),
        ...
        Engine.getInstance().attachStateChange(
          this._onP13nStateChange.bind(this)
        );
      },
      ...
      _onP13nStateChange: function (oEvt) {
              ...
              try {
                if (
                  sap.ui
                    .getCore()
                    .byId(oStateItem.key)
                    .getBindingContext("filters")
                ) {
                  var oItemContext = sap.ui
                    .getCore()
                    .byId(oStateItem.key)
                    .getBindingContext("filters");
                ...
                console.log("_onP13nStateChange", error);
              }
            }.bind(this)
          );
        ...
        if (oEvt.getParameter("control") === oP13nTableFilter) {
          console.log("oP13nTableFilter");
        }
      },
      ...
      onGridFilterSelect: function (oEvent) {
        ...
        Engine.getInstance()
          ...
          .then(function (oState) {
            ...
            Engine.getInstance().applyState(oGridFilter, oState);
          });
      },
